<template>
  <component :is="tag" :class="`title title--${color}`">
    <slot />
  </component>
</template>
...
<docs>
  ```jsx
  <div>
    <Title tag="h1">The quick brown fox</Title>
    <Title tag="h2">The quick brown fox</Title>
    <Title tag="h3">The quick brown fox</Title>
    <Title tag="h4">The quick brown fox</Title>
  </div>
  ```
</docs>
